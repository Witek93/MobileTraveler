...
//        example_wawel_1km_range();
    ...
    /**
     * Przyk³ad, który przeszukuje dosyæ du¿y obszar (1km kw.) z placem zamkowym
    ...
    private static void example_walk_Cracow(String tag) throws IOException, ParserConfigurationException, SAXException {
        ...
        System.out.println("koœció³ Œw. Wojciecha:");
        printTags(50.060808, 19.937849, range, tag); // koœció³ Œw. Wojciecha
        System.out.println("Plac Dominikañski/Grodzka:");
        printTags(50.059099, 19.937892, range, tag); // Plac Dominikañski/Grodzka
        System.out.println("Plac Bernardyñski:");
        printTags(50.054041, 19.938162, range, tag); // Plac Bernardyñski
        System.out.println("wejœcie na Wawel:");
        printTags(50.052780, 19.935271, range, tag); // wejœcie na Wawel
